      ...
      <section className="bg-gradient-to-r from-brandBlue to-blue-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            and drive your business forward with efficiency and reliability.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600 mb-6 text-lg">
                Reliable freight transportation services across Arizona and nationwide. 
                Our modern fleet and experienced drivers ensure your cargo arrives safely and on time.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Last-Mile Delivery</h4>
              <p className="text-gray-600 text-sm mb-4">
                Final delivery solutions to get your products to end customers.
              </p>
              <Link to="/contact" className="text-brandBlue hover:text-blue-700 font-medium text-sm">
                Learn More →
              </Link>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Expert advice to optimize your logistics operations and reduce costs.
              </p>
              <Link to="/contact" className="text-brandBlue hover:text-blue-700 font-medium text-sm">
                Learn More →
              </Link>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center bg-white p-8 rounded-xl shadow-md">
              ...
              <p className="text-gray-600">
                Comprehensive reporting and analytics to help you make informed decisions about your logistics.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-brandBlue text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contact us today to discuss your logistics needs and discover how Arizona GLF 
            can help streamline your supply chain operations.
          </p>
          <div className="space-x-4">
            <Link
              to="/contact"
              className="bg-white text-brandBlue px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block"
            >
              Get Quote
            </Link>
            <Link
              to="/about"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-brandBlue transition-colors inline-block"
            >
              Learn More
            </Link>
          </div>
